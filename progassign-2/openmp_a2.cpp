...
#define PAD 8 // This allocates 64 bytes in L1 cache // The program is made a but more faster
...
#pragma omp parallel
  ...
  if (sudoko_check == false)
    op << "The Sudoko is invalid" << endl;
  else
    op << "The Sudoko is valid" << endl;
